...
Router.route('/latest/:postsLimit?', {name: 'newPosts'});

Router.route('/top/:postsLimit?', {name: 'bestPosts'});
...
Router.onBeforeAction(requireLogin, {only: 'myProfile'});
